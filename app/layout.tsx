  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* font-display=optional prevents invisible text during font swap and avoids layout shift */}
        <link
          href="https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@400;500;600;700&display=optional"
          rel="stylesheet"
        />
      </head>
      <body>{children}</body>
